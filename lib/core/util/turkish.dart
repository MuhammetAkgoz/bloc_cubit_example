...
extension TurkishStrings on String {
  ...
  int compareToTr(String other, [bool ignoreCase = false]) => turkish.compareToTr(this, other, ignoreCase);
}
...
class Turkish {
  ...
  static int _compareToTr(String a, String b, bool ignoreCase) {
    ...
    for (var i = 0; i < len; i++) {
      ...
      final aCodePointTr =
          ignoreCase != true ? _codeUnitLookup.getOrder(aCodePoint) : _codeUnitLookup.getOrderIgnoreCase(aCodePoint);

      final bCodePointTr =
          ignoreCase != true ? _codeUnitLookup.getOrder(bCodePoint) : _codeUnitLookup.getOrderIgnoreCase(bCodePoint);
